...
#reticulate::py_install("fastexcel")
```
...
```{python}
aeroportos = pl.read_csv("../Downloads/airports.csv",
...
```{python}
wdi = pl.read_excel("../Downloads/WDIEXCEL.xlsx", 
sheet_name = "Country", 
...
```{python}
voos = pl.read_csv("../Downloads/flights.csv",
